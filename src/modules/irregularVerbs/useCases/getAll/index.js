...
exports.GetAllIrregularVerbsController = void 0;
const tsyringe_1 = require("tsyringe");
const UserCase_1 = require("./UserCase");
class GetAllIrregularVerbsController {
    handle(Request, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const service = tsyringe_1.container.resolve(UserCase_1.GetAllIrregularVerbsUseCase);
            const irregularVerbs = yield service.execute();
